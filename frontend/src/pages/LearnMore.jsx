...
import { Info, ShieldCheck, Activity, Globe, Cpu } from "lucide-react";
  ...
  const topics = [
    {
      ...
      icon: Cpu,
      color: "bg-blue-500/10 text-blue-400 shadow-blue-500/30",
    },
    {
      ...
      icon: Activity,
      color: "bg-cyan-500/10 text-cyan-400 shadow-cyan-500/30",
    },
    {
      ...
      icon: ShieldCheck,
      color: "bg-emerald-500/10 text-emerald-400 shadow-emerald-500/30",
    },
    {
      ...
      icon: Globe,
      color: "bg-violet-500/10 text-violet-400 shadow-violet-500/30",
    },
    {
      ...
      icon: Info,
      color: "bg-yellow-500/10 text-yellow-400 shadow-yellow-500/30",
    },
  ];
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {topics.map((topic, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`group cursor-pointer p-6 rounded-2xl bg-gray-900/60 border border-gray-800 backdrop-blur-xl 
              hover:-translate-y-1 hover:scale-105 hover:shadow-lg transition-all ${topic.color}`}
            >
              <div
                className={`flex items-center justify-center w-14 h-14 rounded-xl mb-4 ${topic.color} group-hover:scale-110 transition-transform`}
              >
